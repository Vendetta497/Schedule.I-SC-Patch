...
[Youtube教程视频](https://youtu.be/Jv9FmfwJCVg)


## 汉化补丁的安装
[下载release](https://github.com/Vendetta497/Schedule.I-SC-Patch/releases)的Schedule.I_SC.7z

**先备份原来的schedule1_data文件的sharedassets0.assets文件，再解压缩汉化补丁到游戏根目录，安装即完成**
...
### 字体问题
汉化出现**口口口的，粉屏，闪退的（均为缺字体错误）**， 还原备份再下载字体替换工具替换字体（**该工具仅仅是解决字体问题的，不能解决melonloader问题**）
